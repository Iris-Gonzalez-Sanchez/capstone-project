        ...
        <div>
          ...
          <div className="main-container">
            ...
            <div className="textBox">
              ...
              <h3>
                Click the Stock tab above to add stocks you'd like to track onto
                your UserPage 😄
              </h3>
            ...
            <img
              className="gif-here"
              src="https://media3.giphy.com/media/3o7buf6dkxZUWiHVW8/giphy.gif?cid=790b76115c9afdae28b1ddf6efdb37a4991a0e47148b84a7&rid=giphy.gif&ct=g"
              alt="logo"
            ></img>
          </div>
